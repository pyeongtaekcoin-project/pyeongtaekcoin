Pyeongtaekcoin Core version 0.13.0 is now available from:

  <https://pyeongtaekcoin.org/bin/pyeongtaekcoin-core-0.13.0/>
...
141](https://github.com/pyeongtaekcoin/bips/blob/master/bip-0141.mediawiki), [BIP
143](https://github.com/pyeongtaekcoin/bips/blob/master/bip-0143.mediawiki), [BIP
144](https://github.com/pyeongtaekcoin/bips/blob/master/bip-0144.mediawiki), and [BIP
145](https://github.com/pyeongtaekcoin/bips/blob/master/bip-0145.mediawiki) are
finished and included in this release.  However, BIP 141 does not yet specify
activation parameters on mainnet, and so this release does not support segwit
use on mainnet.  Testnet use is supported, and after BIP 141 is updated with
proposed parameters, a future release of Pyeongtaekcoin Core is expected that
...
- #7550 `8b958ab` Input-from-stdin mode for pyeongtaekcoin-cli (laanwj)
...
- #7692 `29b2be6` Remove P2P alert system (ptcdrak)
...
- #8275 `042c323` Remove bad chain alert partition check (ptcdrak)
...
- #7619 `18b3f1b` Add missing sudo entry in gitian VM setup (ptcdrak)
- #7616 `639ec58`  [depends] Delete unused patches  (MarcoFalke)
- #7658 `c15eb28` Add curl to Gitian setup instructions (ptcdrak)
...
- #7613 `3798e5d` Add autocomplete to pyeongtaekcoin-qt's console window (GamerSg)
...
- #7636 `fb0ac48` Add pyeongtaekcoin address label to request payment QR code (makevoid)
- #8231 `760a6c7` Fix a bug where the SplashScreen will not be hidden during startup (jonasschnelli)
- #8256 `af2421c` BUG: pyeongtaekcoin-qt crash (fsb4000)
- #8257 `ff03c50` Do not ask a UI question from pyeongtaekcoind (sipa)
- #8288 `91abb77` Network-specific example address (laanwj)
- #7707 `a914968` UI support for abandoned transactions (jonasschnelli)
- #8207 `f7a403b` Add a link to the Pyeongtaekcoin-Core repository and website to the About Dialog (MarcoFalke)
...
- #7531 `18cb2d5` Add bip68-sequence.py to extended rpc tests (ptcdrak)
...
- #7773 `7c80e72` Fix comments in tests (ptcdrak)
...
- #8047 `37f9a1f` Test_framework: Set wait-timeout for pyeongtaekcoind procs (MarcoFalke)
...
- #8164 `0f24eaf` [Pyeongtaekcoin-Tx] fix missing test fixtures, fix 32bit atoi issue (jonasschnelli)
...
- #7744 `d8e862a` test_framework: detect failure of pyeongtaekcoind startup (laanwj)
...
- #7975 `fc23fee` Update pyeongtaekcoin-core GitHub links (MarcoFalke)
...
- #7540 `ff46dd4` Rename OP_NOP3 to OP_CHECKSEQUENCEVERIFY (ptcdrak)
