Pyeongtaekcoin Core version 0.10.4 is now available from:

  <https://pyeongtaekcoin.org/bin/pyeongtaekcoin-core-0.10.4/>
...
- #6953 `43c2789` Split pyeongtaekcoin-tx into its own package
- #6953 `dfe0d4d` Include pyeongtaekcoin-tx binary on Debian/Ubuntu
