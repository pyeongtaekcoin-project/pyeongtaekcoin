Pyeongtaekcoin Core version 0.13.2 is now available from:
  ...
  <https://pyeongtaekcoin.org/bin/pyeongtaekcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update pyeongtaekcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow pyeongtaekcoin-tx to create v2 transactions (ptcdrak)
