Pyeongtaekcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/pyeongtaekcoin/files/Pyeongtaekcoin/pyeongtaekcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Pyeongtaekcoin
...
New/changed settings (command-line or pyeongtaekcoin.conf file)
--------------------------------------------------------
