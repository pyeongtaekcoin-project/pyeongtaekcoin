Pyeongtaekcoin Core version 0.9.4 is now available from:

  https://pyeongtaekcoin.org/bin/0.9.4/
...
this update is incompatible with the Pyeongtaekcoin system and could lead to consensus
forks.

Pyeongtaekcoin Core released binaries from https://pyeongtaekcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~pyeongtaekcoin/+archive/ubuntu/pyeongtaekcoin
- A third-party or self-compiled Pyeongtaekcoin Core

upgrade to Pyeongtaekcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
