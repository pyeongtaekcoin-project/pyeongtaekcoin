Pyeongtaekcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/pyeongtaekcoin/files/Pyeongtaekcoin/pyeongtaekcoin-0.5.4/
...
http://gitorious.org/pyeongtaekcoin/pyeongtaekcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Pyeongtaekcoin-Qt notifications under Growl 1.3.
Increase required age of Pyeongtaekcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxPyeongtaekcoin properly when installing Pyeongtaekcoin-Qt over it. (Windows)
