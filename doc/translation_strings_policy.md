...
This document provides guidelines for internationalization of the Pyeongtaekcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `pyeongtaekcoin_en.ts` remains unchanged.
