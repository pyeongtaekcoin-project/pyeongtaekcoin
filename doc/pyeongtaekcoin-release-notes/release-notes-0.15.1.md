...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 mPTC per kB (0.00001 PTC). This is to prepare for dropping the minimum transaction fee to 0.1 mPTC per kB (0.0001 PTC) in the next release.
...
- #11433 `e169349` Restore pyeongtaekcoin-util-test py2 compatibility (MarcoFalke)
- #11308 `2e1ac70` zapwallettxes: Wait up to 3s for mempool reload (MarcoFalke)
- #10798 `716066d` test pyeongtaekcoin-cli (jnewbery)
...
- #11125 `812c870` Add pyeongtaekcoin-cli -stdin and -stdinrpcpass functional tests (promag)
- #11077 `1d80d1e` fix timeout issues from TestNode (jnewbery)
- #11078 `f1ced0d` Make p2p-leaktests.py more robust (jnewbery)
- #11210 `f3f7891` Stop test_pyeongtaekcoin-qt touching ~/.pyeongtaekcoin (MeshCollider)
...
### Miscellaneous
- #11377 `75997c3` Disallow uncompressed pubkeys in pyeongtaekcoin-tx [multisig] output adds (TheBlueMatt)
