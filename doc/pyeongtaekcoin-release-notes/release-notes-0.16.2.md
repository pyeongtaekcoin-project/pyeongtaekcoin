...
- #12843 `df38b13` Test starting pyeongtaekcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure pyeongtaekcoind processes are cleaned up when tests end (sdaftuar)
...
- #13797 `6518bcd` pyeongtaekcoinconsensus: invalid flags should be set to pyeongtaekcoinconsensus_error type, add test cases covering pyeongtaekcoinconsensus error codes (Thomas Kerin)
