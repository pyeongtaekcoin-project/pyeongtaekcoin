...
* pyeongtaekcoin.conf: contains configuration settings for pyeongtaekcoind or pyeongtaekcoin-qt
* pyeongtaekcoind.pid: stores the process id of pyeongtaekcoind while running
...
* debug.log: contains debug information and general logging generated by pyeongtaekcoind or pyeongtaekcoin-qt
