...
class WalletTest(PyeongtaekcoinTestFramework):
    ...
    def run_test(self):
        ...
        # node0 should end up with 100 ptc in block rewards plus fees, but
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/pyeongtaekcoin/pyeongtaekcoin/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
