...
# TestP2PConn: A peer we use to send messages to pyeongtaekcoind, and store responses.
...
class CompactBlocksTest(PyeongtaekcoinTestFramework):
    ...
    # This test actually causes pyeongtaekcoind to (reasonably!) disconnect us, so do this last.
    ...
    # pyeongtaekcoind's choice of nonce.
    ...
    # Test that pyeongtaekcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for pyeongtaekcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # pyeongtaekcoind will not send blocktxn responses for blocks whose height is
