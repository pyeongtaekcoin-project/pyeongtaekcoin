...
from test_framework.test_framework import PyeongtaekcoinTestFramework, SkipTest
...
class BumpFeeTest(PyeongtaekcoinTestFramework):
    ...
    def run_test(self):
        ...
        # fund rbf node with 10 coins of 0.001 ptc (100,000 satoshis)
