...
class BIP66Test(PyeongtaekcoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # pyeongtaekcoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and pyeongtaekcoind produces more specific reject
            # reasons.
