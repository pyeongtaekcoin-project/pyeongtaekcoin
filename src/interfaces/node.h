...
#ifndef PYEONGTAEKCOIN_INTERFACES_NODE_H
#define PYEONGTAEKCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a pyeongtaekcoin node (pyeongtaekcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // PYEONGTAEKCOIN_INTERFACES_NODE_H
