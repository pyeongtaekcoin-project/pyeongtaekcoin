    ...
    mapper(0)
{
    ...
    ui->pyeongtaekcoinAtStartup->setToolTip(ui->pyeongtaekcoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->pyeongtaekcoinAtStartup->setText(ui->pyeongtaekcoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openPyeongtaekcoinConfButton->setToolTip(ui->openPyeongtaekcoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new PyeongtaekcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->pyeongtaekcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openPyeongtaekcoinConfButton_clicked()
{
    ...
    if (!GUIUtil::openPyeongtaekcoinConf())
