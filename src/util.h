 ...
 */
#ifndef PYEONGTAEKCOIN_UTIL_H
#define PYEONGTAEKCOIN_UTIL_H
...
extern const char * const PYEONGTAEKCOIN_CONF_FILENAME;
extern const char * const PYEONGTAEKCOIN_PID_FILENAME;
