...
#ifndef PYEONGTAEKCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define PYEONGTAEKCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // PYEONGTAEKCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
