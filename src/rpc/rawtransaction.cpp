...
{
    // Call into TxToUniv() in pyeongtaekcoin-common to decode the transaction hex.
    //
    // Blockchain contextual information (confirmations and blocktime) is not
    // available to code in pyeongtaekcoin-common, so we query them here and push the
