...
#ifndef PYEONGTAEKCOIN_WALLET_WALLET_H
#define PYEONGTAEKCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this pyeongtaekcoin node, and set to 0 for transactions that were created
...
#endif // PYEONGTAEKCOIN_WALLET_WALLET_H
