...
{
    BOOST_CHECK(TestSplitHost("www.pyeongtaekcoincore.org", "www.pyeongtaekcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.pyeongtaekcoincore.org]", "www.pyeongtaekcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.pyeongtaekcoincore.org:80", "www.pyeongtaekcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.pyeongtaekcoincore.org]:80", "www.pyeongtaekcoincore.org", 80));
