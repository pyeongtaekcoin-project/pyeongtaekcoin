...
#ifndef PYEONGTAEKCOIN_TEST_SCRIPTNUM10_H
#define PYEONGTAEKCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Pyeongtaekcoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // PYEONGTAEKCOIN_TEST_BIGNUM_H
